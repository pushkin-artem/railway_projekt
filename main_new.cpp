        ...
        for(auto & x : allomasok)
        {
            ...
            //Грузы и вагоны на станциях
                if(x.kocsi.kocsi_helye != "x" && x.csomag.csomag_kezdohelye != "x")
                {
                    ...
                    {
                        if(x.csomag.csomag_mennyiseg >= x.kocsi.kocsi_kapacitas && x.kocsi.kocsi_kapacitas != 0)
                        {
                            x.csomag.csomag_mennyiseg = x.csomag.csomag_mennyiseg - x.kocsi.kocsi_kapacitas;

                            x.vonat.kocsi.benne = x.vonat.kocsi.benne + x.kocsi.kocsi_kapacitas;

                            cout << "pakol " << x.kocsi.kocsi_nev << " " << x.csomag.csomag_nev << " " << x.vonat.kocsi.benne << endl;

                            shipment[x.csomag.csomag_nev] = x.vonat.kocsi.benne;
                            x.vonat.kocsi.benne = 0;
                            x.kocsi.kocsi_kapacitas = 0;
                        }
                        else if(x.csomag.csomag_mennyiseg > 0 && x.kocsi.kocsi_kapacitas != 0)
                        {
            ...
            {
                if(x.kocsi.kocsi_szabad == true && x.kocsi.kocsi_helye != "x" && x.vonat.vonat_biras > 0)
                {
                    cout << "csatol " << x.kocsi.kocsi_nev << " " << x.vonat.vonat_nev << endl;
                ...
                {
                    //cout << "lecsatol " << x.kocsi.kocsi_nev << " " << x.vonat.vonat_nev << endl;
